...
public class HashMessage extends HashCommon{
    ...
    */
    ...
    protected void DecodeFromCBORObject(CBORObject messageObject) throws CoseException {
        if (messageObject.size() != 4) throw new CoseException("Invalid Hash structure");
        ...
        if (messageObject.get(3).getType() == CBORType.ByteString) rgbHash = messageObject.get(3).GetByteString();
    ...
    protected CBORObject EncodeCBORObject() throws CoseException {
        if (rgbHash == null) throw new CoseException("hash function not called");
