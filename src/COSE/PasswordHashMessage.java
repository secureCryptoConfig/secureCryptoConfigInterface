...
public class PasswordHashMessage extends PasswordHashCommon{
   ...
   The message content will be emitted.
    ...
    protected void DecodeFromCBORObject(CBORObject messageObject) throws CoseException {
        if (messageObject.size() != 5) throw new CoseException("Invalid Hash structure");
        ...
        else throw new CoseException("Invalid Hash structure");
        ...
        else if (!messageObject.get(2).isNull()) throw new CoseException("Invalid Hash structure");
        
        if (messageObject.get(3).getType() == CBORType.ByteString) rgbHashed = messageObject.get(3).GetByteString();
        else throw new CoseException("Invalid Hash structure");
        
        if (messageObject.get(4).getType() == CBORType.ByteString) salt = messageObject.get(4).GetByteString();
        else throw new CoseException("Invalid Hash structure");
    ...
    protected CBORObject EncodeCBORObject() throws CoseException {
        if (rgbHashed == null) throw new CoseException("hash function not called");
