...
public class UseCases {
	...
	public static SCCCiphertext symmetricEncryptWithParams(AbstractSCCKey key, PlaintextContainerInterface plaintext, int nonceLength, int tagLength, String algo) {
		try {
	...
	public static SCCCiphertext asymmetricEncryptWithParams(AbstractSCCKeyPair keyPair, PlaintextContainerInterface plaintext, String algo) {
		try {
			Cipher cipher = Cipher.getInstance(algo);
